...
class S3Stack(Stack):
    def __init__(
        ...
        **kwargs
        ...
        self.raw_bucket_name_output = CfnOutput(self, "RawBucketNameOutput", value=raw_bucket.bucket_name, export_name="RawBucket1")
        self.redacted_bucket_name_output = CfnOutput(self, "RedactedBucketNameOutput", value=redacted_bucket.bucket_name, export_name="RedactedBucket1")
        self.inventory_table_name_output = CfnOutput(self, "EmailInventoryTableNameOutput", value=email_dynamodb_table.table_name, export_name="EmailInventoryTableName1")
        self.inventory_table_arn_output = CfnOutput(self, "EmailInventoryTableARNOutput", value=email_dynamodb_table.table_arn, export_name="EmailInventoryTableArn1")
        self.lambda_role_output = CfnOutput(self, "LambdaRoleOutput", value=lambda_role.role_arn, export_name="LambdaRole1")
        self.ses_role_output = CfnOutput(self, "SESRoleOutput", value=ses_role.role_arn, export_name="SESRole1")
        self.vpc_id_output = CfnOutput(self, "VPCIDOutput", value=vpc_id, export_name="VPCID1")
        self.security_group_id_output = CfnOutput(self, "SecurityGroupIDOutput", value=security_group.security_group_id, export_name="SecurityGroupID1")
        self.s3_access_logs_bucket_output = CfnOutput(self, "AccessLogsBucketOutput", value=s3_access_logs_bucket.bucket_name, export_name="AccessLogsBucket1")
